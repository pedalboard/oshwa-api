...
// checks if the ProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines{}

// ProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines I will only use the certification mark in compliance with official certification guidelines.
type ProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines struct {
...
func NewProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines() *ProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines {
	this := ProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines{}
	return &this
}
...
func (o ProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines) MarshalJSON() ([]byte, error) {
...
func (o ProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines) ToMap() (map[string]interface{}, error) {
...
type NullableProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines struct {
	value *ProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines
	isSet bool
}

func (v NullableProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines) Get() *ProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines {
	return v.value
}

func (v *NullableProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines) Set(val *ProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines(val *ProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines) *NullableProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines {
	return &NullableProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines{value: val, isSet: true}
}

func (v NullableProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectCertificationMarkTermsComplianceWithOfficialCertificationGuidelines) UnmarshalJSON(src []byte) error {
	v.isSet = true
