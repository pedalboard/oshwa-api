...
type ApiApiCompaniesNameGetRequest struct {
	ctx context.Context
...
func (r ApiApiCompaniesNameGetRequest) Limit(limit int32) ApiApiCompaniesNameGetRequest {
	r.limit = &limit
	return r
}

// The number of records to skip when retrieving results
func (r ApiApiCompaniesNameGetRequest) Offset(offset int32) ApiApiCompaniesNameGetRequest {
	r.offset = &offset
	return r
}

func (r ApiApiCompaniesNameGetRequest) Execute() (*PublicProjects, *http.Response, error) {
	return r.ApiService.ApiCompaniesNameGetExecute(r)
}

/*
ApiCompaniesNameGet Search by company name

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param name
 @return ApiApiCompaniesNameGetRequest
*/
func (a *CompanyAPIService) ApiCompaniesNameGet(ctx context.Context, name string) ApiApiCompaniesNameGetRequest {
	return ApiApiCompaniesNameGetRequest{
		ApiService: a,
		ctx: ctx,
		name: name,
...
func (a *CompanyAPIService) ApiCompaniesNameGetExecute(r ApiApiCompaniesNameGetRequest) (*PublicProjects, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CompanyAPIService.ApiCompaniesNameGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/companies/{name}"
