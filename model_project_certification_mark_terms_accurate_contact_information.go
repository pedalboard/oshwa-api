...
// checks if the ProjectCertificationMarkTermsAccurateContactInformation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectCertificationMarkTermsAccurateContactInformation{}

// ProjectCertificationMarkTermsAccurateContactInformation I have provided OSHWA with accurate contact information, recognize that all official communications from OSHWA will be directed to that contact information, and will update that contact information as necessary.
type ProjectCertificationMarkTermsAccurateContactInformation struct {
...
func NewProjectCertificationMarkTermsAccurateContactInformation() *ProjectCertificationMarkTermsAccurateContactInformation {
	this := ProjectCertificationMarkTermsAccurateContactInformation{}
	return &this
}
...
func (o ProjectCertificationMarkTermsAccurateContactInformation) MarshalJSON() ([]byte, error) {
...
func (o ProjectCertificationMarkTermsAccurateContactInformation) ToMap() (map[string]interface{}, error) {
...
type NullableProjectCertificationMarkTermsAccurateContactInformation struct {
	value *ProjectCertificationMarkTermsAccurateContactInformation
	isSet bool
}

func (v NullableProjectCertificationMarkTermsAccurateContactInformation) Get() *ProjectCertificationMarkTermsAccurateContactInformation {
	return v.value
}

func (v *NullableProjectCertificationMarkTermsAccurateContactInformation) Set(val *ProjectCertificationMarkTermsAccurateContactInformation) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectCertificationMarkTermsAccurateContactInformation) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectCertificationMarkTermsAccurateContactInformation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectCertificationMarkTermsAccurateContactInformation(val *ProjectCertificationMarkTermsAccurateContactInformation) *NullableProjectCertificationMarkTermsAccurateContactInformation {
	return &NullableProjectCertificationMarkTermsAccurateContactInformation{value: val, isSet: true}
}

func (v NullableProjectCertificationMarkTermsAccurateContactInformation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectCertificationMarkTermsAccurateContactInformation) UnmarshalJSON(src []byte) error {
	v.isSet = true
