...
// checks if the ProjectCertificationMarkTermsResponsibility type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectCertificationMarkTermsResponsibility{}

// ProjectCertificationMarkTermsResponsibility I have the ability to bind those responsible for the certified item to this agreement.
type ProjectCertificationMarkTermsResponsibility struct {
...
func NewProjectCertificationMarkTermsResponsibility() *ProjectCertificationMarkTermsResponsibility {
	this := ProjectCertificationMarkTermsResponsibility{}
	return &this
}
...
func (o ProjectCertificationMarkTermsResponsibility) MarshalJSON() ([]byte, error) {
...
func (o ProjectCertificationMarkTermsResponsibility) ToMap() (map[string]interface{}, error) {
...
type NullableProjectCertificationMarkTermsResponsibility struct {
	value *ProjectCertificationMarkTermsResponsibility
	isSet bool
}

func (v NullableProjectCertificationMarkTermsResponsibility) Get() *ProjectCertificationMarkTermsResponsibility {
	return v.value
}

func (v *NullableProjectCertificationMarkTermsResponsibility) Set(val *ProjectCertificationMarkTermsResponsibility) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectCertificationMarkTermsResponsibility) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectCertificationMarkTermsResponsibility) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectCertificationMarkTermsResponsibility(val *ProjectCertificationMarkTermsResponsibility) *NullableProjectCertificationMarkTermsResponsibility {
	return &NullableProjectCertificationMarkTermsResponsibility{value: val, isSet: true}
}

func (v NullableProjectCertificationMarkTermsResponsibility) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectCertificationMarkTermsResponsibility) UnmarshalJSON(src []byte) error {
	v.isSet = true
